...
summary: 'Distributionally robust inventory optimization under independent demands. In this work, we generalize Scarf’s classical min-max newsvendor model from a single-period setting to a multiperiod inventory system with independent demand across periods, which enables some new models in supply chain management.'
tags:
  - Journal
